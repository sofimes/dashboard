...
//   return (
//     <div className="search-sync">
//       <div className="row">
//         <input
//           placeholder="Enter ASIN or comma-separated ASINs (e.g. B073JYC4XM)"
//           value={value}
//           onChange={(e) => setValue(e.target.value)}
//         />
//         <button onClick={() => runSync()} disabled={loading || !value.trim()}>
...
//       <div className="log">
//         {log.map((l, i) => (
//           <div key={i} className={l.ok ? "log-ok" : "log-fail"}>
